...
const compare_scores_descending = (score1, score2) => {
...
contestant_ids.sort((id1, id2) => {
    ...
    if (compare_scores_descending(effective_scores[id1], effective_scores[id2]))
        return -1;
    else if (compare_scores_descending(effective_scores[id2], effective_scores[id1]))
        return 1;
    else
        return 0;
});
...
contestant_ids.forEach((contestant_id, index) => {
    ...
    const contestant = contestant_details[contestant_id];
    const top_row = [];
